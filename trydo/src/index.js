...
// Home layout
import Main from './dark/PortfolioLanding';
...
//         \ | |
//       .--''/
//     /o     \ - hey here is where we import the project components for our page !!!
//     \      /
//     {>o<}='

import PythonMachineLearningPage from "./elements/PythonMachineLearningPage";
...
//our pages for our services
import AppDev from "./elements/ElsowinyServices/services/AppDevelopment";
import WebDev from "./elements/ElsowinyServices/services/WebDevelopment";

//import ElsowinyServices from './elements/ElsowinyServices/ElsowinyServices';
...
//         \ | |
//       .--''/
//     /o     \ - hey here is where we change the project urls and route them to the component !!!
//     \      /
//     {>o<}='

*/}
                   {/* We declare our services pages and portfolio projects here */}
                   <Route exact path={`${process.env.PUBLIC_URL}/python-machine-learning`} component={PythonMachineLearningPage}/> 

                   <Route exact path={`${process.env.PUBLIC_URL}/services/app-dev`} component={AppDev}/>
                   <Route exact path={`${process.env.PUBLIC_URL}/services/web-dev`} component={WebDev}/>
