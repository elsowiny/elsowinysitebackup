...
class PythonMachineLearningPage extends Component{
    constructor () {
        super()
        this.state = {
          isOpen: false
    ...
    render(){
        return(
            <React.Fragment>
                ...
                <div className="rn-page-title-area pt--120 pb--190 bg_image python"  data-black-overlay="7">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 className="title theme-gradient">Python Machine Learning</h2>
...
export default PythonMachineLearningPage;
